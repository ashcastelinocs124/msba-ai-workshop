...
```{raw} html
<p class="wk-lede">Every chapter of this book is set at one company. Read this page first: the people, the product, and the plan are the same from chapter 1 to chapter 10.</p>
```
