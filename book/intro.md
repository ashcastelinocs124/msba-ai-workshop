...
```{raw} html
<p class="wk-lede">An interactive textbook for the Gies MSBA workshop series on AI, machine learning, and financial markets. Ten chapters in five parts. Every chapter has code you can run in the page, a visual explainer you can poke, a checkpoint quiz, and a Colab notebook for the real thing.</p>
```
...
1. **Objectives** — three things you can do by the end.
...
|---|---|---|
| 0 · Foundations for AI | 0, 0A–0F | How does a large language model work and how is it trained, what is the difference between open and closed models, what do training and answering cost, what is an API, and how do MCP and agent skills extend an agent? |
